...
(defun color-theme-dark-hron ()
  "Color theme by Aleksei Gusev, created 2010-03-31."
  (interactive)
  (color-theme-install
   '(color-theme-dark-hron
     ...
     (default ((t (:stipple nil :background "black" :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 115 :width normal :foundry "xos4" :family "Terminus"))))
