...
(defun color-theme-dark-hron ()
  ...
  (color-theme-install
   '(color-theme-dark-hron
     ...
     (ediff-current-diff-A ((t (:background "#3c3c3c" :bold t))))
     (ediff-current-diff-Ancestor ((t (:background "#3c3c14" :bold t))))
     (ediff-current-diff-B ((t (:background "#3c3c34" :bold t))))
     (ediff-current-diff-C ((t (:background "#3c3c2c" :bold t))))
     ...
     (ediff-fine-diff-A ((t (:background "#3c3c1c"  :bold t))))
     (ediff-fine-diff-Ancestor ((t (:background "#3c3c24" :bold t))))
     (ediff-fine-diff-B ((t (:background "#3c3c04" :bold t))))
     (ediff-fine-diff-C ((t (:background "#3c3c0c" :bold t))))
