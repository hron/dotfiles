 ...
 '(safe-local-variable-values
   (quote
    ((ruby-test-specification-filename-mapping
     ...
     (ruby-test-specification-filename-mapping
      ("\\(.*\\)\\(lib/active_merchant/billing/gateways/\\)\\(.*\\)\\([^/]*\\)\\(\\.rb\\)$" "\\1test/unit/gateways/\\3_test\\4\\5"))
     ...
     (ruby-test-implementation-filename-mapping
      ("\\(.*\\)\\(spec/\\)\\(.*\\)\\([^/]*\\)\\(_spec\\)\\(\\.rb\\)$" "\\1lib/\\2\\3\\4\\5"))
     (ruby-test-specification-filename-mapping
      ("\\(.*\\)\\(lib\\)\\(.*\\)\\([^/]*\\)\\(\\.rb\\)$" "\\1spec/\\3_spec\\4\\5"))
     (ruby-test-specification-filename-mapping
      (("\\(.*\\)\\(lib\\)\\(.*\\)\\([^/]*\\)\\(\\.rb\\)$" "\\1spec/\\3_spec\\4\\5")))
     (ruby-test-specification-filename-mapping
      (quote
     ...
     (phpunit-run-directory . "/home/gusev/src/z/zanby/core")
     (js2-strict-missing-semi-warning)
     (js2-strict-missing-semi-warning . 100)
