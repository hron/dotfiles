...
wicked.register(netwidget, wicked.widgets.net,
    '<span color="green">â–¾</span>${' .. netif .. 
    ' down} <span color="red">â–´</span>${' .. netif .. ' up} ')
-- }}}
...
function show_new_mails()
    ...
    for email in lfs.dir(maildir .. "/new") do
        if email ~= "." and email ~= ".." then
            ...
            text = text .. setFg(beautiful.mail_notify_fg_bar, "â•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œâ•Œ\n")
